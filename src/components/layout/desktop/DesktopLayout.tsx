            ...
            <Layout>
                <Header className={'horizontal-center'} style={{ position: 'fixed', zIndex: 1, width: '100%',  userSelect: 'none'}}>
                    <div style={{ width: '1400px' }}>
                        <div className={'vertical-center'}style={{ float: 'left', fontSize:'24px',paddingLeft:'10px',color:'white' }}><img src={logo} style={{ height: '42px',paddingRight:'15px'}} />WebTetrado</div>
