    ...
    return (
        <div>
            ...
            <p style={{ textAlign: 'center' }}>
                <b>Figure 1.</b> Layer diagram of quadruplex. Black arrows indicate progression from 5’ to 3’ end. Nucleotides are displayed as rhombuses with their sequential numeric id.
            </p>
            <h3 id={"secondary_drawing_pseudoknot"}>
                3.4. Pseudoknot annotation scripts
            </h3>
            <p>
            ...
            <h3 id={"secondary_drawing_interactions"}>
                3.5. Scripts to annotate non-canonical interactions
            </h3>
            <p>
